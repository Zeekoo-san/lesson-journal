...
from lesson_journal.cli import main
from lesson_journal.models import Note, ProjectState, Task
from lesson_journal.cli import demo_state
from lesson_journal.storage import load_state, save_state
